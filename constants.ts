...
export const ROOMS: Room[] = [
  { 
    ...
    capacity: 3, baseCapacity: 2, extraPersonPrice: 20.00, 
    price: 85.00, color: 'bg-blue-100 border-blue-300 text-blue-800', 
  ...
  { 
    ...
    price: 75.00, color: 'bg-green-100 border-green-300 text-green-800', 
  ...
  { 
    ...
    capacity: 2, baseCapacity: 2, extraPersonPrice: 0, 
    price: 125.00, color: 'bg-purple-100 border-purple-300 text-purple-800', 
    hasBathroom: true, description: '최고급 침구와 넓은 공간을 자랑하는 스위트룸입니다.', 
    building: 'B동', roomNumber: '201호' 
  },
  { 
    id: '202', name: '패밀리 로프트', type: '복층', 
    capacity: 6, baseCapacity: 4, extraPersonPrice: 25.00, 
    price: 160.00, color: 'bg-orange-100 border-orange-300 text-orange-800', 
  ...
  { 
    ...
    price: 55.00, color: 'bg-gray-100 border-gray-300 text-gray-800', 
...
export const INITIAL_SERVICES: ServiceDefinition[] = [
  { id: 's1', name: '주말식사', defaultPrice: 15.00, type: 'meal' },
  { id: 's2', name: '공항 픽업', defaultPrice: 35.00, type: 'pickup' },
  { id: 's3', name: '출퇴근 셔틀', defaultPrice: 10.00, type: 'custom' },
  { id: 's4', name: '렌트카', defaultPrice: 60.00, type: 'rental' },
];
